  ...
  return (
    <>
      <div className="hidden lg:block h-screen ">
        <div className="image__gradient-forgot w-full h-full"></div>
      </div>

      <div className="flex items-center justify-center bg-black text-white">
        <div className=" p-4 max-w-md w-full">
          <div>
            <h1 className="text-4xl uppercase -skew-x-12 font-bold text-center pb-1">TeamTasker</h1>
          ...
          <nav className="flex flex-col items-center gap-2 font-medium">
            ...
            <small className='text-sm font-normal'>ó</small>
